...
const removeUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (userRoutines.length > 0) {
            userRoutines.forEach((routine) => __awaiter(void 0, void 0, void 0, function* () {
                for (let groupExerciseIndex = 0; groupExerciseIndex < routine.GroupExercises.length; groupExerciseIndex++) {
                    for (let configurationIndex = 0; configurationIndex < routine.GroupExercises[groupExerciseIndex].ExerciseConfigurations.length; configurationIndex++) {
                        yield ExerciseConfiguration.destroy({
                            where: {
        ...
        const clientGroup = yield ClientGroup_1.default.findAll({ where: { idUser: userId } });
        if (clientGroup) {
...
exports.default = { getUsers: exports.getUsers, getUser: exports.getUser, getUserRoutines: exports.getUserRoutines, updateUser: exports.updateUser, getClients: exports.getClients, createClient: exports.createClient };
