...
//Post relations
Post_1.default.belongsTo(Coach_1.default, { foreignKey: 'idCoach' });
Coach_1.default.hasMany(Post_1.default, { foreignKey: 'idCoach' });
...
Comment_1.default.belongsTo(Coach_1.default, { foreignKey: 'idCoach' });
Coach_1.default.hasMany(Comment_1.default, { foreignKey: 'idCoach' });
