...
const items = [
  getItem("General", "sub1", <FcConferenceCall size={20} />, [
    getItem("Hoy", "noticias"),
  ]),
  getItem("Perfil", "sub2", <FcConferenceCall size={20} />, [
    getItem("Ver perfil", "listaDeUsuarios"),
  ]),
  getItem("Mi rutina", "sub3", <FcShipped size={20} />, [
    getItem("Rutina hoy", "listaDeRutinas"),
    getItem("Rutina mes", "agregarRutina"),
  ]),
        ...
        <div className="logo flex items-center justify-center">
          {collapsed ? (
            ...
            <div className="flex items-start justify-start m-10">
              <h2 className="mainTitle text-black">
                USUARIO
                <br />
                SeM
              </h2>
